 ...
 */
public class GooglePlusActivity extends android.support.v7.app.AppCompatActivity implements
    ...
    protected void updateUI(boolean isSignedIn) {
        if (isSignedIn) {
            // Show signed-in user's name
            String name = "Test Name"; //Plus.PeopleApi.getCurrentPerson(mGoogleApiClient).getDisplayName();
